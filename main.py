...
viptime = 100
ALLOWED_GROUP_ID = -4976242572   # ID BOX
admin_diggory = "JoonWuy" # ví dụ : để user name admin là @diggory347 bỏ dấu @ đi là đc
name_bot = "Bot Spam Sms"
zalo = "0372065607"
web = "https://trumsubvip.site/"
facebook = "no"
allowed_group_id = -4976242572 # ID BOX
users_keys = {}
key = ""
...
admin_mode = False
share_log = []
tool = 'https://trumsubvip.site/'
BOT_LINK = 'https://t.me/joonwuy_bot'
TOKEN = '7920017466:AAE5B0zIGvJ8wgZ9UpvFUEIjZOf-YzSfMVc'  
bot = TeleBot(TOKEN)
...
def laykey(message):
    ...
    url_key = requests.get(f'https://yeumoney.com/QL_api.php?token=703371951353e080dde13a50207e2ff7c3fc31fe88f765c17fa11d9fd1046528&format=json&url=https://jirayshop.xyz/key.php?r={key}').json()['shortenedUrl']
...
- DÙNG LỆNH /key {{key}} ĐỂ TIẾP TỤC -
 [Lưu ý: mỗi key chỉ có 1 người dùng]
    ...
    admin_button = InlineKeyboardButton(text="WED MXH", url="https://trumsubvip.site/")
